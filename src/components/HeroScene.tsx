...
class WebGLErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    console.warn('HeroScene WebGL/3D Render Error caught:', error, errorInfo);
  }
...
const FallbackBackground = () => (
  <div className="absolute inset-0 bg-gradient-to-br from-[#0A0A0A] via-[#141414] to-[#0A0A0A] opacity-80 overflow-hidden pointer-events-none">
    <div className="absolute top-1/4 left-1/3 w-96 h-96 bg-[#B08D57]/10 rounded-full blur-3xl animate-pulse" />
    <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-[#4F46E5]/10 rounded-full blur-3xl" />
  </div>
);
